...
write.csv(c(resting_R2,flying_R2),file="combined_R2_values_honeybee.csv")
...
even_split = floor(flying_length/4)
...
sample_1000_flying = sample(1:flying_length,size=even_split,replace=FALSE)
...
sample_2500_flying = sample(1:flying_length,size=2*even_split,replace=FALSE)
...
sample_5000_flying = sample(1:flying_length,size=3*even_split,replace=FALSE)
...
sample_7500_flying = sample(1:flying_length,size=flying_length,replace=FALSE)
...
write.csv(cbind(D_resting,D_flying),file="combined_D_values_honeybee.csv")

# data = read.csv("combined_D_values_honeybee.csv")
# D_resting = data[,2]
# D_flying = data[,3]

par(mfrow=c(2,1))
plot(D_resting,main="Resting Honeybee",type='b')
# plot(D_shivering, main="Shivering Bee Case 1",type='b')
plot(D_flying, main="Flying Honeybee",type='b')
